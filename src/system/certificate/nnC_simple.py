...
from .template import ReachCertificateTemplates
...
class NonNegativityConstraint(Constraint):
    ...
    def _extract(self, constraints):
        for q_id in self.template_manager.template.sub_templates.keys():
            constraints.append(
                ConstraintImplication(
                    ...
                    rhs=SubConstraint(
                        expr_1=Inequality(
                            left_equation=self.template_manager.template.sub_templates[q_id],
